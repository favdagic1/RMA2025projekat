package com.favdagic.newsfeedapp.viewmodel

import androidx.lifecycle.ViewModel
import androidx.lifecycle.viewModelScope
import com.favdagic.newsfeedapp.data.network.NewsDAO
import com.favdagic.newsfeedapp.data.network.ImagaDAO
import com.favdagic.newsfeedapp.data.network.api.ImagaApiService
import com.favdagic.newsfeedapp.data.network.api.NewsApiService
import com.favdagic.newsfeedapp.model.NewsItem
import com.favdagic.newsfeedapp.util.Logger
...
class NewsViewModel : ViewModel() {
    ...
    private val _imageTagsFlow = MutableStateFlow<List<com.favdagic.newsfeedapp.data.ImaggaTag>>(emptyList())
    val imageTagsFlow: StateFlow<List<com.favdagic.newsfeedapp.data.ImaggaTag>> = _imageTagsFlow
    ...
    fun loadImageTags(imageUrl: String) {
        ...
        viewModelScope.launch {
            try {
                ...
                val topTags = tagStrings.take(5).map { com.favdagic.newsfeedapp.data.ImaggaTag(it) }
