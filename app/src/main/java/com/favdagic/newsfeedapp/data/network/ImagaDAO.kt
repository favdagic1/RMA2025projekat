package com.favdagic.newsfeedapp.data.network
...
import com.favdagic.newsfeedapp.data.network.exception.InvalidImageURLException
...
class ImagaDAO {
    ...
    private val IMAGGA_API_KEY = com.favdagic.newsfeedapp.BuildConfig.IMAGGA_API_KEY
    private val IMAGGA_API_SECRET = com.favdagic.newsfeedapp.BuildConfig.IMAGGA_API_SECRET
